...
bool Isolate::AddCodeEventListener(ExternalCodeEventListener* code_event_listener) {
...
void Isolate::RemoveCodeEventListener(ExternalCodeEventListener* code_event_listener) {
